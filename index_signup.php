  ...
  <div class="col lg-6 sign-up">
      <div class="form">
        <form action="student_backend/signup.inc.php" method="POST" class="register-form">
          ...
          <input type="text" placeholder="Roll No"  maxlength="10" name="username">
          ...
          <select class="custom-select student-text" name="year">
            ...
            <input type="number" id="phone" name="mobile"  placeholder="Enter the 10 digit number" maxlength="10">
